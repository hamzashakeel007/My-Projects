...
INSERT INTO phone_calls (caller_name, receiver_name) VALUES (value1, value2, value3, ...);

ALTER TABLE phone_calls ADD caller_name = people.name FROM people WHERE phone_calls.caller = people.phone_number;
